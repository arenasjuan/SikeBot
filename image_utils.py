...
class ImageText(object):
    def __init__(self, filename_or_size_or_Image, rotate = 0, mode='RGBA', background=(0, 0, 0, 0),
                 encoding='utf8'):
    ...
    def write_text_box(self, text, box_width, font_filename, midpoint,
        ...
        for index, line in enumerate(lines):
            ...
            if place == 'left':
                ...
                self.write_text((last_word_x, height), words[-1], font_filename,
                                font_size, color)
        numlines = len(lines)
        return (box_width, height - y, len(lines))
